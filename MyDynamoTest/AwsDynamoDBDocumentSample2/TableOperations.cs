...
namespace AwsDynamoDBDocumentSample1
{
    ...
    {
        static readonly string[] SAMPLE_TABLE_NAMES = { "hints" };
        ...
        public static void CreateSampleTables(AmazonDynamoDBClient client)
        {
            ...
            if (!currentTables.Contains("hints"))
            {
                Console.WriteLine("Table hints does not exist, creating");
                client.CreateTable(new CreateTableRequest
                {
                    ...
                    {
                        new AttributeDefinition { AttributeName = "Pack", AttributeType = ScalarAttributeType.S },
                    }
                });
                tablesAdded = true;
            }
